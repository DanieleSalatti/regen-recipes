...
export interface RFStorageTestInterface extends utils.Interface {
  contractName: "RFStorageTest";
  functions: {
...
export interface RFStorageTest extends BaseContract {
  contractName: "RFStorageTest";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RFStorageTestInterface;
