...
export interface RFManagerTestInterface extends utils.Interface {
  contractName: "RFManagerTest";
  functions: {
...
export interface RFManagerTest extends BaseContract {
  contractName: "RFManagerTest";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RFManagerTestInterface;
